...
const dataFiles = [
  ...
  { name: 'backtest_data_1769009635709.json', description: '数据集 2' },
...
async function main() {
  console.log('\n╔════════════════════════════════════════════════════════════════════════════╗');
  console.log('║         Reversal V8.0 策略多数据集回测（分段检测版）                        ║');
  console.log('╚════════════════════════════════════════════════════════════════════════════╝\n');

  console.log('V8.0 策略特性：');
  ...
  console.log('  • 动量确认：连续3个数据点上涨 & 5个数据点涨幅（根据分段调整）\n');
